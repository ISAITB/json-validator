...
public class StatisticReportingAspectTest {
    ...
    void testUploadPointcut() {
        ...
        var target = new UploadController() {
            @Override
            public ModelAndView handleUpload(String domain, MultipartFile file, String uri, String string, String validationType, String contentType, String[] externalSchema, MultipartFile[] externalSchemaFiles, String[] externalSchemaUri, String combinationType, RedirectAttributes redirectAttributes, HttpServletRequest request) {
        ...
        controller.handleUpload("domain1", null, null, null, null, null, null, null, null, null, null, null);
    ...
    void testMinimalUploadPointcut() {
        ...
        aspectFactory.addAspect(aspect);
        UploadController controller = aspectFactory.getProxy();
        controller.handleUploadM("domain1", null, null, null, null, null, null, null, null, null, null, null);
        assertTrue(aspectCalled[0]);
        assertTrue(targetCalled[0]);
    }
